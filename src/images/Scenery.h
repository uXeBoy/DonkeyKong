...
namespace Images {
  ...
  const unsigned char PROGMEM LivesLeft_Mask[] = {
    0x14, 0x3e, 0x7e, 0x7f, 0x7f, 0x3f, 0x1e, 0x0c, 
  };

  const unsigned char PROGMEM Level[] = {
    21, 16,
    0x00, 0xfc, 0x02, 0xfa, 0x82, 0x02, 0xfa, 0xaa, 0x02, 0x7a, 0x82, 0x7a, 0x02, 0xfa, 0xaa, 0x02, 0xfa, 0x82, 0x02, 0xfc, 0x00, 
    0x00, 0x3f, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x3f, 0x00, 
  };
  ...
  const unsigned char PROGMEM Level_Mask[] = {
    ...
    0x3f, 0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f, 0x3f, 
  };

  const unsigned char PROGMEM Buildings[] = {
    63, 16,
